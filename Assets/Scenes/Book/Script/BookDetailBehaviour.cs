...
public class BookDetailBehaviour : BaseBehaviour
{
    ...
    protected override void Start()
    {
        ...
        Debug.Log("BookDetailBehaviour start..");
        setSafearea("BookDetailCanvas");
    ...
    void reload()
    {
        ...
        if (response.field == "terminate" || Param.Category == 4)
    ...
    public void onBackClick()
    {
        ...
        SceneController.Instance.Jump("Book");
    }
