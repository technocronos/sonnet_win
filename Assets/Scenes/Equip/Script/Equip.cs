...
public class Equip : MonoBehaviour, IEnhancedScrollerDelegate
{
    public Quest Quest;

    public Toggle Tab_WPN;
    public Toggle Tab_BOD;
    public Toggle Tab_HED;
    public Toggle Tab_ACS;
    public Toggle Tab_ITM;
    ...
    public void show(string _category = "WPN")
    {
    ...
    public void onStart(string json)
    {
        ...
        switch (category)
        {
            case "HED":
                ...
                break;
            case "BOD":
                if (Tab_BOD.isOn == false)
                    Tab_BOD.isOn = true;
                else
                    reload();
                break;
            case "WPN":
                if (Tab_WPN.isOn == false)
                    Tab_WPN.isOn = true;
                else
                    reload();
                break;
            case "ACS":
                if (Tab_ACS.isOn == false)
                    Tab_ACS.isOn = true;
                else
                    reload();
                break;
            case "ITM":
                if (Tab_ITM.isOn == false)
                    Tab_ITM.isOn = true;
                else
                    reload();
                break;
