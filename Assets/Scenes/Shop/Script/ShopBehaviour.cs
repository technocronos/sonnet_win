...
public class ShopBehaviour : BaseBehaviour
{
    public Image BG;
    ...
    private static ShopBehaviour instance;
    ...
    protected override void Start()
    {
        ...
        Debug.Log("ShopBehaviour start..");
        setSafearea("ShopCanvas");
        ...
        if (Param == null)
        {
            Param = new ShopBehaviour.Parameter
            {
                currency = "gold",
                category = "ITM",
            };
